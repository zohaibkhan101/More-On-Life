...
class HabitAssessmentScreen extends StatefulWidget {
  const HabitAssessmentScreen({super.key});

  @override
  State<HabitAssessmentScreen> createState() => _HabitAssessmentScreenState();
}

class _HabitAssessmentScreenState extends State<HabitAssessmentScreen> {
