...
class HeartAssessmentScreen extends StatefulWidget {
  const HeartAssessmentScreen({super.key});

  @override
  State<HeartAssessmentScreen> createState() => _HeartAssessmentScreenState();
}

class _HeartAssessmentScreenState extends State<HeartAssessmentScreen> {
